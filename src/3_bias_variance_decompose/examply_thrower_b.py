...
def animation():
    ...
    size = 50
    # thrower
    circle(700+rand[0]*size,0,interpolate(0,15,0),color=get_color(0.7))
    circle(700+rand[1]*size,0,interpolate(0,15,10),color=get_color(0.7))
    circle(700+rand[2]*size,0,interpolate(0,15,20),color=get_color(0.7))
    circle(700+rand[3]*size,0,interpolate(0,15,30),color=get_color(0.7))
    circle(700+rand[4]*size,0,interpolate(0,15,40),color=get_color(0.7))
    circle(700+rand[5]*size,0,interpolate(0,15,50),color=get_color(0.7))
