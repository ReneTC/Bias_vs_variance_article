...
def animation():
    ...
    translate(0,-100)
    # rotate(-frame/40)
    text(interpolate(-600,-800,-30,duration=100),0, "Chapter 2", font=fontb,size = 250)
    text(interpolate(-780-200,-780,-30,duration=100),-200, "Bias and variance decomposition", font=fonti,size = 110,color=grey3)
